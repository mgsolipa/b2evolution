tinymce.PluginManager.add("b2evolink", function(a) {
    function b(b) {
        return function() {
        ...
        i = v.getNode(), j = w.getParent(i, "a[href]"), m = h(), u.text = k = j ? j.innerText || j.textContent : v.getContent({
            ...
            onSubmit: function(b) {
                ...
                function d() {
                    ...
                    j ? (a.focus(), m && u.text != k && ("innerText" in j ? j.innerText = u.text : j.textContent = u.text), w.setAttribs(j, b), v.select(j), a.undoManager.add()) : m ? (u.href.substring(0, 1) == "#" && u.href.length > 1) ? a.insertContent("(("+u.href+" "+w.encode(u.text)+"))") : a.insertContent(w.createHTML("a", b, w.encode(u.text))) : a.execCommand("mceInsertLink", !1, b)
                }
                var e;
